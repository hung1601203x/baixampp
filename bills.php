                    ...
                    <div class="border border-gray-100 hover:bg-slate-100 duration-100 text-slate-500 p-4 text-sm relative">
                        ...
                        <form method="POST" class="p-4 flex items-center justify-center gap-4">
                            ...
                            ?>
                                ...
                                <a href="http://localhost/QuanLyKyTucXa/bills_edit.php?ma=<?php echo $bill['id'] ?>" class="cursor-pointer material-symbols-outlined p-2 bg-slate-100 rounded-full hover:bg-slate-200 duration-100">
                                    edit
                                </a>

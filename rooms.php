            ...
            <div class="flex-1 p-4">
                <form method="GET">
                    <div class="flex gap-3 items-center">
                        ...
                        <a href="http://localhost/QuanLyKyTucXa/rooms_add.php" class="text-white bg-slate-800 p-3">+ Thêm mới</a>
                    </div>
                </form>
                ...
                <?php else : ?>
                    ...
                    <div class="grid grid-cols-3 gap-4 text-slate-600">
                        ...
                        <div class="relative">
                            ...
                            <a target="_blank" href="http://localhost/QuanLyKyTucXa/rooms_detail.php?ma=<?php echo $ml_room['id'] ?>" class="block border p-4 <?= $isFull ? 'bg-rose-500 text-white' : '' ?>">
                                ...
                                <a href="http://localhost/QuanLyKyTucXa/rooms_edit.php?ma=<?php echo $ml_room['id'] ?>" class="material-symbols-outlined absolute -top-2 -right-2 p-2 border bg-white rounded-full hover:bg-slate-800 hover:text-white duration-200">
                                    edit
                                </a>
                            </a>
                        </div>
                    ...
                    <div class="grid grid-cols-3 gap-4 text-slate-600">
                        ...
                        <div class="relative">
                            ...
                            <a target="_blank" href="http://localhost/QuanLyKyTucXa/rooms_detail.php?ma=<?php echo $fml_room['id'] ?>" class="block border p-4 relative <?= $isFull ? 'bg-rose-500 text-white' : '' ?>">
                                ...
                                <a href="http://localhost/QuanLyKyTucXa/rooms_edit.php?ma=<?php echo $fml_room['id'] ?>" class="material-symbols-outlined absolute -top-2 -right-2 p-2 border bg-white rounded-full hover:bg-slate-800 hover:text-white duration-200">
                                    edit
                                </a>
                            </a>
                        </div>
